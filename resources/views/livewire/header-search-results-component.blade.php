                ...
                <div class="row pb-3">
                    <div class="col-12 pb-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="ml-2">
                            <select class="form-select btn btn-sm btn-light dropdown-toggle"  aria-label="Default select example" wire:model="sorting">
                                ...
                                <!-- <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" wire:model="sorting">
                                    ...
                                    <!-- </div> -->
                                <!-- </div> -->
                                <select class="form-select btn btn-sm btn-light dropdown-toggle"  aria-label="Default select example" wire:model="pagesize">
                        ...
                        @if($products->count() > 0)
                        <h3>Showing products regarding {{ $search }}</h3>
                    </div>
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" href="" title="Add to favorites"><i class="far fa-heart"></i></a>
                    ...
                    @else
                    <h3>No products regarding to {{$search}}</h3>
                    @endif
                </div>
            </div>
            <!-- Shop Product End -->
