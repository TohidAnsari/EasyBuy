                        ...
                        <tr class="">
                            <td>
                                <img src="{{ asset('storage/products/' . $item->product->image) }}" alt=""
                                    style="width: 50px" /> <br> <b>{{ $item->product->name }}</b>
                            </td>
                            <th>
                            ...
                            @if($order->status == 'delivered' && $order->rs_status == false)
                            <th><a href="{{ route('user.ratereviews', ['order_item_id' => $item->id]) }}" class="btn btn-primary">Rate Product</a></th>
                            @endif
                        </tr>
                        @endforeach
                    </table>
